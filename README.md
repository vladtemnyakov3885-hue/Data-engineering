...
- Источник: Google Drive файл US_Accidents_March23.csv  
- Размер файла: 3.06 GB  

После загрузки:  
- Объём данных: 7,728,394 записи о ДТП  
- Количество признаков: 46 колонок  
- География: данные по всей территории США  
